...
const StayProfile = () => {
    ...
    const { dToken, profileData, setProfileData, getProfileData } = useContext(StayContext)
    ...
    const updateProfile = async () => {
        ...
        try {
            ...
            const { data } = await axios.post(backendUrl + '/api/stay/update-profile', updateData, { headers: { dToken } })
